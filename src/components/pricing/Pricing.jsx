  ...
  return (
    <div className="relative h-fit text-white overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto space-y-9">
        ...
        {/* Header Section */}
        <div className="bg-gradient-to-r from-purple-800/70 to-purple-900/70 rounded-2xl p-4 sm:px-6 text-white backdrop-blur-sm">
        ...
        <div className="bg-gray-900/60 rounded-xl p-8 border border-gray-800/50 flex flex-col lg:flex-row backdrop-blur-md">
          
          {/* Left Side - Features */}
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 pr-0 lg:pr-8 pb-12 lg:pb-0 border-b border-gray-800/50 lg:border-r lg:border-gray-800/50 lg:border-b-0">
